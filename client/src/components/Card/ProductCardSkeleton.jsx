    ...
    <div className="flex flex-inline w-1/2 md:w-1/5 pb-4 px-2">
      <div className="rounded-lg bg-white shadow w-full overflow-hidden">
        ...
        <div className="relative p-2 flex flex-col">
          <div className="mb-1 overflow-hidden line-clamp-2 bg-cool-gray-400 rounded pb-8 animate-pulse"></div>
          <div className="flex justify-between mb-1 text-grey-700 font-bold bg-cool-gray-400 rounded pb-8 animate-pulse"></div>
        </div>
      </div>
    </div>
  );
